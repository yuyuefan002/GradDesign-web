...
//        preg_match用于正则表达式匹配，成功返回1，失败返回0
//        /^表示从字串首项开始匹配
//        （）标记一个子表达式的开始和结束位置。子表达式可以获取供以后使用。
//        [[:alpha:]]代表字母
//        [[:space:]]代表各类型的空格 tab, newline, vertical tab, form feed, carriage
//        可能可以包含空格把，外国人名字有三节？
//        []中括号表达式
//        | 用圆括号将所有选择项括起来，相邻的选择项之间用|分隔
//        所以这里有4个选项 1.字母 2.- 3.空格 4.'
//        *$/表示结束
//        /u 表示按unicode(utf-8)匹配（主要针对多字节比如汉字）
//        参考链接：www.runoob.com/regexp/regexp-syntax.html
